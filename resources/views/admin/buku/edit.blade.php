<x-admin-layout>
    ...
    <x-slot name="subtitle">Perbarui data buku</x-slot>
            ...
            <form action="{{ route('admin.buku.update', $buku) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="tahun" value="{{ old('tahun', $buku->tahun) }}" required min="1900" max="{{ date('Y') }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    @if($buku->cover)
                        <div class="mb-3">
                            <img src="{{ Storage::url($buku->cover) }}" alt="Cover" class="w-24 h-32 object-cover rounded-lg" loading="lazy">
                        </div>
                    @endif
                ...
                <div class="mt-6">
                    ...
                    <textarea name="deskripsi" rows="3"
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('deskripsi', $buku->deskripsi) }}</textarea>
                </div>
